...
MENU_CFG g_menu_cfg[] = {
    ...
    {ENTRY_UPDATE_SYSTEM,     '1',          "1. Load Product System.",      "sysup",        NULL,         ENTRY_DISPLAY},
    ...
    {ENTRY_SET_BAUDRATE,      '2',          "2. SetSN utilities.",           "set_sn", NULL,         ENTRY_DISPLAY},
    {ENTRY_SET_PASSWORD,      '3',          "3. SetMac utilities.",          "set_mac",      NULL,         ENTRY_DISPLAY},
