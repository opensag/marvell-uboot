...
MENU_CFG g_menu_cfg[] = {
    ...
    {ENTRY_SEL_SYS_IDX,       '3',          "3. Scattered utilities.",             	  "make_part",        NULL,         ENTRY_DISPLAY},	
    {ENTRY_SET_BAUDRATE,      '4',          "4. SetSN utilities.",                    "set_sn", NULL,         ENTRY_DISPLAY},
    {ENTRY_SET_PASSWORD,      '5',          "5. SetMac utilities.",                   "set_mac",      NULL,         ENTRY_DISPLAY},
    {ENTRY_BOOT_CHECK_VERSION,'6',          "6. boot wifi check version.",            "boot_checkver",      NULL,         ENTRY_HIDE},
