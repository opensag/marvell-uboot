...
DATE=`date +%d%m%Y`
BOOT_DEV=$2  
IMGPATH=$3  #../A3700-utils-marvell/tim/untrusted, Path to image text files
CLOCKSPATH=$4 #../A3700-utils-marvell/ddr/tim_ddr   Clocks and DDR init data path
PRESET=$5   #CPU_800_DDR_800 ,Clocks preset
DDRTOPOLOGY=$6
BOOTPART=$7 #Partition number
PRIMARY=$8 #Build primary or secondary image (1/0)
DEBUG=$9
OUTFILE=${10} #../A3700-utils-marvell/atf-ntim.txt, Output TIM/NTIM file name
